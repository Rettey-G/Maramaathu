...
const enTranslations: Record<string, string> = {
  ...
  'auth.signupSubtitle': 'Join thousands of users on Maraamathu',
  ...
  'landing.hero.highlight': 'Maraamathu',
  'landing.hero.subtitle': 'The trusted marketplace for home services in Maldives. Connect with skilled workers for repairs, cleaning, and more.',
  ...
  'landing.features.title': 'Why Choose Maraamathu?',
  ...
  'landing.ctaSection.subtitle': 'Join thousands of satisfied customers and workers on Maraamathu today',
...
const dvTranslations: Record<string, string> = {
  ...
  'auth.signupSubtitle': 'މާރާމަތުގެ ހާޒާރު ޔޫސަރުންނާ ގުޅިފައި ކުރިއަށް',
  ...
  'landing.hero.highlight': 'މާރާމަތުން',
  ...
  'landing.features.title': 'މާރާމަތު ކޮށްފަސް؟',
  ...
  'roleSelect.subtitle': 'މާރާމަތު ކިޔާނީ ކިހިނެއްކަން ދަންނަވާ',
